...
<template>
  <AlertDialogPortal>
    <AlertDialogOverlay
      ...
      class="data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 z-100 bg-black/40 duration-150 ease-spring"
    />
    <AlertDialogContent
