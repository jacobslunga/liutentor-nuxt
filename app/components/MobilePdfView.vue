...
<template>
  <div class="relative h-dvh w-full bg-default overflow-hidden">
    <div
      class="absolute inset-x-0 top-0 z-30 bg-default border-b border-default pt-[env(safe-area-inset-top,0px)]"
    >
    ...
    >
      <section
        v-show="showSolution"
        class="fixed inset-0 z-40 h-dvh w-screen bg-default overflow-hidden"
        role="dialog"
        aria-modal="true"
      >
        <div
