...
<template>
  <div class="mx-auto max-w-6xl px-5 sm:px-8">
    <nav aria-label="Innehåll" class="pt-12 sm:pt-16">
      <p class="text-sm font-medium text-muted">Innehåll</p>
    ...
    <div class="mt-16 sm:mt-24">
      ...
      >
        <div class="lg:sticky lg:top-24 lg:self-start">
          <span class="text-xs tabular-nums text-primary">{{
            entry.number
          }}</span>
          <h2
            class="mt-2 font-serif text-lg font-medium leading-snug text-highlighted"
          >
            {{ entry.title }}
          </h2>
        </div>
