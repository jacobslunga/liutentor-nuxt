...
<template>
  <div
    ref="dropZoneRef"
    class="relative flex h-full w-full flex-col overflow-hidden bg-default"
  >
    ...
    >
      ...
      >
        ...
        <div class="space-y-2">
          ...
          <p
            class="mx-auto max-w-70 text-sm leading-relaxed text-muted sm:max-w-md"
          >
      ...
      <ChatMessages
        ...
        content-class="pt-16 pb-36 sm:pb-44"
        @reply-to-selection="handleReplyToSelection"
      />

      <template #prompt>
        <div
          class="pointer-events-none absolute inset-x-0 bottom-0 z-20 flex flex-col items-center bg-linear-to-t from-default to-transparent pt-10 pb-3 sm:pb-4"
        >
          <Transition name="fade-up">
            <UButton
              ...
              class="pointer-events-auto mb-2.5 size-8 p-0 shadow-md"
          ...
          <ChatInput
            ref="chatInputRef"
            class="pointer-events-auto mx-auto w-full max-w-2xl 3xl:max-w-3xl"
