...
<template>
  <aside class="hidden lg:block">
    <div class="sticky top-16">
      ...
      <div
        class="max-h-[calc(100vh-7rem)] overflow-y-auto border-l border-border/60 pl-3"
      >
        <p
          v-if="!historyEnabled"
        ...
        <div v-else class="flex flex-col gap-2">
          <button
            ...
            :key="item.id"
            type="button"
            class="group cursor-pointer w-full rounded-md border px-3 py-3 text-left transition-colors"
            :class="
