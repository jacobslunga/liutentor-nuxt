...
<template>
  <div>
    <div class="mb-10 text-2xl font-medium leading-snug text-foreground sm:text-3xl lg:text-4xl">
      <QuizMarkdown :content="question.question" class="text-xl font-medium text-foreground" />
    </div>
