...
<template>
  <div class="w-full">
    <div class="mb-6 flex items-end justify-between">
      <div>
        <p class="mb-1 text-2xs font-medium text-muted/60">Resultat</p>
    ...
    <div class="mb-8 rounded-md border border-dashed border-default/60 p-4">
      ...
      <div class="flex items-center gap-2">
        <UButton
          ...
          @click="emit('retake')"
        >
          <UIcon name="i-openai-rotate-clockwise" class="h-3.5 w-3.5" />
          Gör om
        </UButton>
    ...
    <div class="flex flex-col gap-3">
      ...
      >
        <div class="mb-3 flex items-center gap-2">
          <span
            class="inline-flex items-center rounded-sm border border-default bg-muted/40 px-2 py-0.5 text-2xs"
          >
            Fråga {{ qi + 1 }}
          </span>
          <span
