...
<template>
  <div class="px-4 bg-transparent relative w-full pointer-events-auto z-10">
    ...
    <div class="max-w-2xl mx-auto relative">
      <Transition name="fade-up">
        ...
        >
          <Button
            variant="outline"
            size="icon"
            class="rounded-full bg-background/60 backdrop-blur-sm"
      ...
      <div class="space-y-2">
        <div
          class="border border-border bg-background transition-colors duration-150 focus-within:border-border"
