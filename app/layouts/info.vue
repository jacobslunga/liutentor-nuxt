...
<template>
  <div class="flex min-h-screen flex-col bg-default">
    <header class="sticky top-0 z-30 h-14 shrink-0 border-b bg-default transition-colors duration-200 ease-spring"
      ...
      <div class="mx-auto flex h-full max-w-6xl items-center justify-between px-5 sm:px-8">
        ...
        <UButton color="neutral" variant="outline" size="sm" @click="openUploadModal()">
