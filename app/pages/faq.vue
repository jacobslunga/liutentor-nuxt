...
useSeoMeta({
  ...
  description:
    "Svar på vanliga frågor om LiU Tentor, tentamaterial, uppladdningar och statistik.",
  robots: "index, follow",
});
  ...
  <div>
    ...
    <div class="mx-auto max-w-6xl px-5 sm:px-8">
      <section
        ...
        :key="group.label"
        class="grid gap-x-12 gap-y-2 py-8 lg:grid-cols-[13rem_minmax(0,1fr)] lg:py-10"
        :class="i > 0 ? 'border-t' : ''"
      >
        <p
          class="pt-6 text-sm font-medium text-muted lg:sticky lg:top-24 lg:self-start"
        >
          {{ group.label }}
        </p>
