...
<template>
  <div class="flex flex-col gap-8">
    <template v-if="profileLoading">
      <section class="relative overflow-hidden rounded-3xl bg-elevated p-8">
        ...
        />
        <div class="h-4 w-56 rounded-md bg-muted animate-pulse mx-auto mt-4" />
    ...
    <template v-else>
      <section class="relative p-6 sm:p-8">
        <div class="relative z-10 flex flex-col items-center text-center">
          ...
          <p class="text-xs text-muted/80">Medlem sedan {{ memberSince }}</p>
          ...
          <div class="mt-6 w-full max-w-2xl">
            ...
            >
              <div class="grid grid-cols-3 gap-2 sm:gap-3">
                ...
                >
                  <p class="text-2xs text-muted">Quiz</p>
                ...
                <div
                  class="rounded-md border border-default bg-default/70 p-3 sm:p-4"
                >
                  <p class="text-2xs text-muted">AI Chattar</p>
                  <p class="mt-1 text-xl sm:text-2xl font-medium tabular-nums">
                ...
                <div
                  class="rounded-md border border-default bg-default/70 p-3 sm:p-4"
                >
                  <p class="text-2xs text-muted">Meddelanden</p>
                  <p class="mt-1 text-xl sm:text-2xl font-medium tabular-nums">
          ...
          <div class="rounded-md border border-default bg-elevated p-5">
            ...
            <div class="space-y-3">
              <div class="flex flex-col gap-1.5">
                <label class="text-xs text-muted">Förnamn</label>
                <input
              ...
              <div class="flex flex-col gap-1.5">
                <label class="text-xs text-muted">Efternamn</label>
                <input
          ...
          >
            <div class="p-5">
              ...
              <div class="space-y-2 text-sm">
                ...
                <p class="flex items-center justify-between gap-3">
                  <span class="text-muted">Kontostatus</span>
                  <span
            ...
            <div class="p-5 flex items-center justify-between gap-3">
              <div>
                ...
                <p class="text-xs text-muted">Avsluta din nuvarande session</p>
              </div>
              <UButton
                color="neutral"
                variant="outline"
              ...
              >
                <UIcon
                  ...
                  class="w-4 h-4 animate-spin"
                />
                <UIcon name="i-tabler-logout" v-else class="w-4 h-4" />
