        ...
        >
            <div class="max-w-xl text-center">
                ...
                <p class="mt-2 text-sm text-muted-foreground">
                    Har du en gammal tenta eller ett facit? Ladda upp den här så
                    blir nästa student som söker på {{ courseCode }} hjälpt
                    direkt.
                </p>
            </div>
            <ExamUploadForm
        ...
        <template v-else-if="courseData">
            <div class="flex justify-center">
                <div class="flex flex-col items-start w-full max-w-2xl gap-8">
                    ...
                    >
                        <div
                            class="min-w-fit w-full rounded-2xl overflow-hidden"
                        >
                            <div
