...
useSeoMeta({
  title: "AI-policy",
  description:
    "Läs om hur vi använder AI på LiU Tentor och vad du bör tänka på som användare.",
  robots: "index, follow",
});
...
<template>
  <div class="w-full max-w-3xl">
    ...
    <div
      class="mt-8 pt-6 border-t bg-primary/5 rounded-xl p-6 border border-primary/10"
    >
