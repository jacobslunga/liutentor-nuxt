import { defineComponent, unref, mergeProps, withCtx, renderSlot, createVNode, openBlock, createBlock, createCommentVNode, useSSRContext, createTextVNode } from 'vue';
...
import { c as cn, a as _sfc_main$2$1 } from './server.mjs';
                  ...
                  if (__props.showCloseButton) {
                    _push3(ssrRenderComponent(unref(DialogClose), {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(ssrRenderComponent(_component_LucideX, null, null, _parent4, _scopeId3));
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.showCloseButton) {
        _push(ssrRenderComponent(unref(DialogClose), { "as-child": "" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(unref(_sfc_main$2$1), { variant: "outline" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(` Close `);
                  } else {
              ...
              return [
                createVNode(unref(_sfc_main$2$1), { variant: "outline" }, {
                  default: withCtx(() => [
                    createTextVNode(" Close ")
                  ]),
                  _: 1
                      ...
                      if (_push4) {
                        ...
                        _push4(ssrRenderComponent(unref(DialogClose), { class: "absolute top-4 right-4 p-0.5 transition-colors rounded-md hover:bg-secondary" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(_component_LucideX, { class: "w-4 h-4" }, null, _parent5, _scopeId4));
                              _push5(`<span class="sr-only"${_scopeId4}>Close</span>`);
                            } else {
                              return [
                                createVNode(_component_LucideX, { class: "w-4 h-4" }),
                                createVNode("span", { class: "sr-only" }, "Close")
                              ];
                            }
                          }),
...
export { _sfc_main$9 as _, _sfc_main as a, _sfc_main$6 as b, _sfc_main$3 as c, _sfc_main$1 as d, _sfc_main$5 as e, _sfc_main$8 as f };
//# sourceMappingURL=DialogTrigger-zc1GJJHL.mjs.map
