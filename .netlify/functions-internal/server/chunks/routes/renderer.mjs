...
import { b as buildAssetsURL, a as useRuntimeConfig, e as getResponseStatusText, f as getResponseStatus, h as defineRenderHandler, p as publicAssetsURL, i as getQuery, c as createError, j as destr, k as getRouteRules, l as joinURL, m as useNitroApp } from '../nitro/nitro.mjs';
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"name":"description","content":"Hitta och plugga på gamla tentor från Linköpings Universitet"},{"name":"robots","content":"index, follow"},{"name":"format-detection","content":"telephone=no"},{"property":"og:site_name","content":"LiU Tentor"},{"property":"og:type","content":"website"},{"property":"og:title","content":"LiU Tentor - Gamla tentor från Linköpings Universitet"},{"property":"og:description","content":"Hitta och plugga på gamla tentor från Linköpings Universitet"},{"property":"og:locale","content":"sv_SE"},{"name":"twitter:card","content":"summary"},{"name":"twitter:title","content":"LiU Tentor - Gamla tentor från Linköpings Universitet"},{"name":"twitter:description","content":"Hitta och plugga på gamla tentor från Linköpings Universitet"},{"name":"theme-color","content":"#ffffff"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"},{"rel":"manifest","href":"/site.webmanifest"},{"rel":"stylesheet","href":"https://cdn.jsdelivr.net/npm/katex@0.16.9/dist/katex.min.css"}],"style":[],"script":[],"noscript":[],"titleTemplate":"%s | LiU Tentor","htmlAttrs":{"lang":"sv"},"charset":"utf-8","viewport":"width=device-width, initial-scale=1"};
